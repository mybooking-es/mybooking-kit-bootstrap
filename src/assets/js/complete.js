      ...
      $.ajax({
            ...
            success: function(data, textStatus, jqXHR) {
                ...
                if (payNow && payment_method_id != null && payment_method_id != '') {
                    ...
                    window.location.href = 'summary.html?id=' + bookingId;
                }
            },
            error: function(data, textStatus, jqXHR) {
        ...
        $('form[name=reservation_form]').validate(
            {
                ...
                invalidHandler : function (form, validator) {
                    $('#reservation_error').html('El formulario contiene errores. Por favor, revíselo');
                ...
                messages : {
                    ...
                    'customer_surname' : 'Apellidos del cliente obligatorios',
                    'customer_email' : {
                        required: 'Correo electrónico del cliente obligatorios',
                        email: 'El formato del correo electrónico no es válido'
                    },
                    'customer_email_confirmation': {
                        'required': 'Confirmación del correo electrónico del cliente obligatorio',
                        email: 'El formato del correo electrónico no es válido',
                        'equalTo': 'La confirmación debe ser igual al correo electrónico'
                    },
                    'customer_phone': {
                        'required': 'Teléfono del cliente obligatorio',
                        'minlength': 'Longitud mínima del teléfono del cliente'
                    },
                    'driver_date_of_birth': {
                        'required': 'Edad del conductor es obligatoria'
                    },
                    'conditions_read': 'No ha marcado que ha leído las condiciones'
